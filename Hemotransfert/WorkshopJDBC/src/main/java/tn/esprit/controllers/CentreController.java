...
import tn.esprit.models.Centre;
...
public class CentreController implements Initializable {
    ...
    private void initializePagination() {
        ...
        pagination.setPageFactory(pageIndex -> {
            ...
            colnom.setCellValueFactory(new PropertyValueFactory<Centre,String>("nom"));
            colcontact.setCellValueFactory(new PropertyValueFactory<Centre,String>("contact"));
            colcoordonne.setCellValueFactory(new PropertyValueFactory<Centre,String>("coordonnegeo"));
            coladresse.setCellValueFactory(new PropertyValueFactory<Centre,String>("adresse"));
